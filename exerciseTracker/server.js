...
var exerciseClass = mongoose.model(
  'exerciseLog',
  new mongoose.Schema({ username: String, _id: String, log: [] })
);
  ...
  exerciseClass
    ...
    .exec(function(err, data) {
      ...
      if (data == null) {
        ...
        data.log = data.log.slice(
          req.query.limit > data.log.length - 1 ? 0 : -req.query.limit
        );
